...
plt.plot(xC, yIC, '-', color = 'blue', label = 'I', linewidth = 5)
plt.plot(xC, yC_C, '-', color = 'red', label = 'I+R', linewidth = 5)
plt.plot(xC, yRC, '-', color = 'green', label = 'R', linewidth = 5)
...
plt.plot(xK, yIK, '-', color = 'blue', label = 'I', linewidth = 5)
plt.plot(xK, yK_C, '-', color = 'red', label = 'I+R', linewidth = 5)
plt.plot(xK, yRK, '-', color = 'green', label = 'R', linewidth = 5)
...
plt.plot(xIta, yIIta, '-', color = 'blue', label = 'I', linewidth = 5)
plt.plot(xIta, yIta_C, '-', color = 'red', label = 'I+R', linewidth = 5)
plt.plot(xIta, yRIta, '-', color = 'green', label = 'R', linewidth = 5)
